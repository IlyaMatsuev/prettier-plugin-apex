...
pkg-script "prettier:named" "prettier --plugin=@ilyamatsuev/prettier-plugin-apex NonEmptyNamedClass.cls"
pkg-script "prettier:anonymous" "prettier --plugin=@ilyamatsuev/prettier-plugin-apex --parser apex-anonymous AnonymousClass.cls"
