...
| `apexFormatAnnotations`       | `false`     | Format Apex annotations to the upper camel case, adding spaces between annotation arguments. Also converts `testmethod` modifier to `@IsTest` case.                                                                                                                                                                                              |
